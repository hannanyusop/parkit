...
@section('content')
    <section class="content">
        ...
        <h2 class="section-title">Senarai Pengumuman</h2>
        <p class="section-lead">Pengumuman akan disusun mengikut tarikh Pengumuman.</p>
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4></h4>
                    <div class="card-header-action">
                        <a href="{{ route('frontend.user.portal.announcement.create') }}" class="btn btn-success"><i class="fa fa-plus"></i> Tambah Pengumuman</a>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <form class="form-inline mb-3" method="get">
                        ...
                        <input type="text" name="title" class="form-control mb-2 mr-sm-2 col-md-6" id="title" value="{{ request('title') }}" placeholder="Tajuk Pengumuman">
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu" style="">
                                                ...
                                                <button class="dropdown-item text-danger text-sm" data-url="{{ route('frontend.user.portal.announcement.delete', $announcement->id) }}" data-title="Pengumuman" data-delete="Adakah anda ingin memadam ini Pengumuman ini?"><i class="fa fa-trash"></i> Padam</button>
                                            </div>
                                        </div>
                                    </td>
                                </tr>

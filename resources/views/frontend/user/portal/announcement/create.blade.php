...
@section('content')
    <section class="content">
        <div class="col-md-8 offset-md-2">
            <div class="card">
                <x-forms.post :action="route('frontend.user.portal.announcement.insert')" class="form-horizontal" enctype="multipart/form-data">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control datepicker"  name="show_until" id="show_until" value="{{ old('show_until') }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea class="summernote" name="text" id="text">{{ old('text') }}</textarea>
                            </div>
                        </div>
                    </div>

                ...
                <x-forms.post :action="route('frontend.user.campaign.insert')" class="form-horizontal">
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="name" placeholder="EX: EVENT POLL 2020">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="inputEmail3" class="col-sm-2 col-form-label">Campaign Code</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="code" id="code" placeholder="EX:EVENTPOLL2020">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="target_participation" id="target_participation" placeholder="EX:10">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control float-right" id="campaigndatetime">
                                </div>
                            </div>
                        </div>
                    </div>

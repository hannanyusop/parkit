...
//        });
    ...
    Route::group([
        ...
        Route::group([
            ...
            Route::get('checkout-insert/{id}', [KehadiaranController::class, 'checkoutInsert'])->name('checkout-insert');
        });
        ...
        Route::group([
            ...
            Route::get('printQrByClass/{class_id}', [ClassroomTeacherController::class, 'printQrByClass'])->name('printQrByClass');
